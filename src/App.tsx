...
import type { ChartType } from './components/ChartsSection'
  ...
  return (
    <EyeDataProvider>
      <div className="h-screen w-screen bg-[#DCE2F0] font-sans select-none overflow-hidden flex flex-col relative">
        ...
        {/* Toolbar Icons Row */}
        <div className="bg-white border-b border-gray-300 p-1 flex gap-2 shadow-sm z-40 h-10 items-center px-4">
        ...
        <div className="flex-1 relative p-4 flex flex-col overflow-hidden">
          {/* Background Phoropter Silhouette */}
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            {/* Refraction Table - Centered */}
            <div className="flex justify-center mt-4">
              <RefractionTable />
            </div>

            {/* Middle Controls Row: Occluder - PD - Occluder */}
